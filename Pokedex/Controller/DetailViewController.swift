...
class DetailViewController: UIViewController {
    ...
    lazy var scrollView: UIScrollView = {
        ...
        scrollView.contentSize.height = .greatestFiniteMagnitude
    ...
    private func setUpUI() {
        ...
        self.spriteImageView.heightAnchor.constraint(equalToConstant: 150).isActive = true
        self.spriteImageView.widthAnchor.constraint(equalToConstant: 150).isActive = true
